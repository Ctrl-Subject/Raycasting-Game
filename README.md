...
g++ "src/main.cpp" "src/UI/Framework.cpp" "src/Handler/Handler.c" "src/Handler/TEMPSETS.c" -std=c++17 -o main.exe -I "src" -I "extern/SolarUI/include" -L "extern/SolarUI/lib/x64" -lSolarUI -lfreeglut -lopengl32 -lglu32